		...
		<div class="layui-row layui-col-space15">
			<div class="layui-col-md8">
				<div class="layui-row layui-col-space15">
						...
						<div class="layui-card">
							...
							<div class="layui-card-body">
								<form class="layui-form" action="">
									...
									<div class="layui-form-item">
										<div class="layui-inline">
											<label class="layui-form-label">KEY长度</label>
											<div class="layui-input-inline">
												<input type="text" id="linenum" name="linenum" lay-verify="required|number|length" autocomplete="off" class="layui-input">
											</div>
										</div>
									</div>
									<div class="layui-form-item">
										<div class="layui-input-block;">
											<button type="submit" class="layui-btn" lay-submit="" lay-filter="demo1">开始分析</button>
					...
					<!-- IP分组Start -->
					<div class="layui-col-md6">
						<div class="layui-card" style="width: 551px;">
