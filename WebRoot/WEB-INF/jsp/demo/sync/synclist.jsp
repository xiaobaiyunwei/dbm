...
<!-- 查询条件end -->
<util:getListForPage sqlMapId="demo_sqlserver" stmtCount="ns.sns.demo.getSnsDemoListCount" stmt="ns.sns.demo.getSnsDemoList" varCount="totalCount" pageCount="${pageInfo.pageSize}"
