...
<form id="add_form" action="${_currConText}/demo/sync/syncadd.shtm" method="post">
<table width="700" align="center" cellpadding="0" cellspacing="0"
	style="margin-top: 3px;" class="tikumore">
	<tr>
		<td style="font-size: 12px; padding: 5px;">名字</td>
		<td style="font-size: 12px; padding: 5px;"><input type='text'
			id="name" name="name" validate="required:true,maxlength:10" value="">
		</td>
	</tr>
	<tr>
		<td style="font-size: 12px; padding: 5px;">年龄</td>
		<td style="font-size: 12px; padding: 5px;"><input type='text'
			id="age" name="age" validate="required:true,number:true,maxlength:3"
			value=""></td>
	</tr>
	<tr>
		<td style="font-size: 12px; padding: 5px;">手机号</td>
		<td style="font-size: 12px; padding: 5px;"><input type='text'
			id="phone" name="phone" validate="phone:true,required:true" value="">
		</td>
	</tr>
	<tr>
